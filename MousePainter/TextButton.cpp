...
std::string TextButton::getImage()
{
	return image;
}
...
void TextButton::setSize(int x, int y)
{
	sizeX = x;
	sizeY = y;
}
...
int TextButton::getPosX()
{
	return posX;
}

int TextButton::getPosY()
{
	return posY;
}

int TextButton::getSizeX()
{
	return sizeX;
}

int TextButton::getSizeY()
{
	return sizeY;
}